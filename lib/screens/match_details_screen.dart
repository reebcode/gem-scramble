...
class _MatchDetailsScreenState extends State<MatchDetailsScreen> {
  ...
  Widget _buildBody() {
    ...
    // For completed matches, only show actual players
    // For waiting/in-progress matches, show up to maxPlayers (if available)
    ...
    for (int i = 0; i < totalSlots; i++) {
      if (i < players.length) {
        ...
        // Only show empty slots for non-completed matches
        slots.add(_playerTile(
