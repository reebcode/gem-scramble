...
class _WalletScreenState extends State<WalletScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) context.read<WalletProvider>().refreshTransactions();
    });
  }
    ...
    return Consumer<WalletProvider>(
      builder: (context, wallet, _) {
        ...
        return RefreshIndicator(
          ...
          child: wallet.isLoadingTransactions && transactions.isEmpty
              ? const Center(child: CircularProgressIndicator())
              : transactions.isEmpty
                  ? _buildEmptyHistory(wallet.transactionsError)
                  : ListView.builder(
                      padding: const EdgeInsets.all(16),
  ...
  Widget _buildEmptyHistory(String? error) {
    return Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          Icon(
            error != null ? Icons.error_outline : Icons.receipt_long,
            size: 64,
