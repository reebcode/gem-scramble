class Lobby {
  ...
  final List<double> payoutMultipliers; // e.g., [3, 1.5, 0.5]
  ...
  const Lobby({
    ...
    required this.payoutMultipliers,
  ...
  factory Lobby.fromJson(Map<String, dynamic> json) {
    return Lobby(
      ...
      payoutMultipliers: (json['payoutMultipliers'] as List<dynamic>?)
              ?.map((e) => (e as num).toDouble())
              .toList() ??
          [3.0, 1.5, 0.5], // Default multipliers
  ...
  Lobby copyWith({
    ...
    return Lobby(
      ...
      payoutMultipliers: payoutMultipliers ?? this.payoutMultipliers,
